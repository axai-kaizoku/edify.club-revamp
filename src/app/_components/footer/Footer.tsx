...
const Footer = () => {
  return (
    <div className="w-full bg-[#efefef] items-center justify-center h-[100vh] overflow-auto">
      ...
      <div className="relative h-screen bg-red-300 w-full z-10 text-2xl md:text-7xl font-bold uppercase flex justify-center items-center bg-primaryRed text-white whitespace-pre">
        Scroll down ↓
      </div>
      ...
      <div className="sticky z-0  bottom-0 left-0 w-full  bg-black text-white flex flex-col justify-end  items-center">
        <MoreLinks />
        <div className="flex flex-col md:flex-row justify-between h-ful w-full py-8 px-4">
          {/* compnany info */}
