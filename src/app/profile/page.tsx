...
export default function Page() {
  ...
  return (
    <Container className="my-6 lg:my-10 h-full min-h-screen">
      ...
      <div className="flex w-full justify-between lg:items-stretch h-full min-h-0 lg:h-48">
        <div className="flex w-full lg:w-[74%] h-full items-center border border-[#DEDEDE] rounded-xl">
          ...
          <div className="flex flex-col justify-evenly gap-y-3 lg:gap-0 lg:pl-5 items-start w-full h-full">
            ...
            <div className="grid grid-cols-2 lg:flex lg:justify-between w-full h-fit lg:pr-14">
        ...
        <ul className="hidden lg:flex space-y-1 w-[24%] h-full flex-col border border-[#DEDEDE] rounded-xl">
          <li className="flex gap-x-3 items-center h-full w-full text-[#0076FF] font-gilroyMedium whitespace-nowrap px-5 hover:bg-[#F9F9F9] rounded-xl cursor-pointer">
            <Edit /> Edit Profile
          </li>
          <li className="flex gap-x-3 items-center h-full w-full font-gilroyMedium whitespace-nowrap px-5 hover:bg-[#F9F9F9] rounded-xl cursor-pointer">
            <Logout />
            Logout
          </li>
          <li className="flex gap-x-3 items-center h-full w-full text-[#F00] font-gilroyMedium whitespace-nowrap px-5 hover:bg-[#F9F9F9] rounded-xl cursor-pointer">
            <Delete />
            Delete Account
          </li>
        </ul>
